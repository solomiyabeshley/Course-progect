                ...
                <div className="col-md-6 no-padding">
                    <div className="glazing_cold">
                        ...
                        <div className="combiRancho">
                            <img src={Img001} alt=""/>
                            {/*<p>Існує безліч варіантів виконання огорожі «РАНЧО». Дуже цікаво виглядає паркан ранчо в*/}
                            {/*    комбінованому виконанні. Наприклад, певна послідовність по-різному пофарбованих ламелей*/}
                            {/*    або ж поєднання одноколірних ламелей із ламелями, у яких покриття «під дерево»,*/}
                            {/*    підкреслять архітектуру, ландшафт Вашої ділянки або ж додадуть автентичності,*/}
                            {/*    індивідуальності.</p>*/}
                        </div>
                    </div>
